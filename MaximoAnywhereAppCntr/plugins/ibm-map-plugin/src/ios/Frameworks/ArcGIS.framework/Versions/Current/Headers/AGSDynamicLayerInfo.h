...
/** @brief Information about a layer.
 ...
 @define{AGSDynamicLayerInfo, ArcGIS}
 @since 10.2.4
 */
...
/** Initialize a @c AGSDynamicLayerInfo with the given layer ID in a dynamic map service.
 The given @c AGSDrawingInfo will set the renderer used by the service to renderer the sublayer.
 The given @c AGSLayerSource will be used to set a new data source for the sublayer.
...
/** Initialize a @c AGSDynamicLayerInfo with the given layer ID in a dynamic map service.
 ...
 with the @p dynamicLayerInfos property of @c AGSDynamicMapServiceLayer to reorder layers
...
/** Initialize a @c AGSDrawingInfo with the given layer ID in a dynamic map service.
 The given @c AGSDrawingInfo will set the renderer used by the service to renderer the sublayer.
...
/** Create a new @c AGSDynamicLayerInfo with the given layer ID in a dynamic map service.
 The given @c AGSDrawingInfo will set the renderer used by the service to renderer the sublayer.
 The given @c AGSLayerSource will be used to set a new data source for the sublayer.
 @param layerID layer id.
 @param drawingInfo drawing info specifying the renderer.
