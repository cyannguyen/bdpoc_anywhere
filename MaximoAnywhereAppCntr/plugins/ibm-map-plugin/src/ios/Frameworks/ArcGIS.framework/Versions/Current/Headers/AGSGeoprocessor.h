...
/** Executes a geoprocessing task in asynchronous mode - the operation finishes 
 ...
 @agssince{1.0, 10.2}
 @see @c AGSGeoprocessorDelegate#geoprocessor:operation:didSubmitJob: delegate method when job is submitted successfully
 @see @c AGSGeoprocessorDelegate#geoprocessor:operation:ofType:didFailWithError:forJob: delegate method when job submission fails
 @see @c AGSGeoprocessorDelegate#geoprocessor:operation:jobDidSucceed: delegate method when submitted job completes successfully
 @see @c AGSGeoprocessorDelegate#geoprocessor:operation:jobDidFail: delegate method when submitted job fails
...
/** This method fires a request for the status of the job designated by @p jobId.
 ...
 @see @c AGSGeoprocessorDelegate#geoprocessor:operation:didCheckJobStatus:  delegate method for success
 @see @c AGSGeoprocessorDelegate#geoprocessor:operation:ofType:didFailWithError:forJob: delegate method for failure
...
/** Fetch the results of the geoprocessing task. Only relevant for tasks which 
 ...
 @return <code>NSOperation</code> for current request.
 @see @c AGSGeoprocessorDelegate#geoprocessor:operation:didQueryWithResult:forJob: delegate method for success
 @see @c AGSGeoprocessorDelegate#geoprocessor:operation:ofType:didFailWithError:forJob: delegate method for failure
 @agssince{1.0, 10.2}
 */
...
/** Fetch the resulting image of the geoprocessing task when it is associated 
 ...
 @return <code>NSOperation</code> for current request.
 @agssince{1.0, 10.2}
 @see @c AGSGeoprocessorDelegate#geoprocessor:operation:didQueryWithResultImage:forJob: delegate method for success
 @see @c AGSGeoprocessorDelegate#geoprocessor:operation:ofType:didFailWithError:forJob: delegate method for failure
 */
...
/** Fetch the resulting image layer of the geoprocessing task as an 
 ...
 @return <code>NSOperation</code> for current request.
 @agssince{1.0, 10.2}
 @see @c AGSGeoprocessorDelegate#geoprocessor:operation:didQueryWithResultImageLayer:forJob: delegate method for success
 @see @c AGSGeoprocessorDelegate#geoprocessor:operation:ofType:didFailWithError:forJob: delegate method for failure
 */
