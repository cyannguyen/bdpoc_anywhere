...
/** @brief Algorithmic color ramp class
 ...
 @define{AGSAlgorithmicColorRamp.h, ArcGIS}
 @since 10.2.4
 */
@interface AGSAlgorithmicColorRamp : AGSColorRamp

/** The starting color for the @c AGSColorRamp.
 @since 10.2.4
 */
@property (nonatomic, strong) AGSColor *fromColor;

/** The ending color for the @c AGSColorRamp.
 @since 10.2.4
 */
@property (nonatomic, strong) AGSColor *toColor;

/** The @c AGSColorRamp algorithm used to generate intermediate colors
 between the from color and the to color.
 @since 10.2.4
 */
@property (nonatomic, assign) AGSColorRampAlgorithm algorithm;

/** Initialize a @c AGSAlgorithmicColorRamp with the given fromColor, toColor, and algorithm.
...
/** Create a new @c AGSAlgorithmicColorRamp with the given fromColor, toColor, and algorithms.
 @param fromColor the starting color.
 @param toColor the ending color.
 @param algorithm the algorithm used to generate intermediate colors
 between the from color and the to color.
