...
/** A where clause for the query. Any legal SQL where clause operating on the 
 ...
 @deprecated Deprecated at 10.2.4. Please use @c AGSNALayerDefinition#whereClause instead.
 */
...
/** Initialize a new @c AGSNALayerDefinition
 ...
 @agssince{1.8, 10.2}
 @deprecated Deprecated at 10.2.4. Please use @c AGSNALayerDefinition#initWithLayerName:geometry:spatialRelationship:whereClause: instead.
 */
...
/** Initialize a new @c AGSNALayerDefinition.
 ...
 @return An initialized @c AGSNALayerDefinition object.
 @agssince{1.8, 10.2}
 @deprecated Deprecated at 10.2.4. Please use @c AGSNALayerDefinition#initWithLayerName:whereClause: instead.
 */
