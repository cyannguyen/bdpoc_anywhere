...
/** Initialize a  @c AGSLayerMapSource with the map layer id and optionally an alternate geodatabase version.
...
/** Create a new @c AGSLayerMapSource with the map layer id and optionally an alternate geodatabase version.
 @param mapLayerID map layer ID.
 @param geodatabaseVersion specifies an alternate geodatabase version.  If not requried, use @p nil.
