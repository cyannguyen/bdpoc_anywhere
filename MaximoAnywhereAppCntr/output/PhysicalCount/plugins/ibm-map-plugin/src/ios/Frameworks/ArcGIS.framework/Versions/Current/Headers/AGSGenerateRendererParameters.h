...
/** @brief Parameters for a @c AGSGenerateRendererTask
 
 Instances of this class represent parameters for @c AGSGenerateRendererTask operation.
...
/** Initialize a @c AGSGenerateRendererParameters with the given classification definition and where class.
...
/** Create a new @c AGSGenerateRendererParameters with the given classification definition and where class.
 @param classificationDefinition the classification definition used to define the renderer.
 @param whereClause the where clause to narrow the range of the data to be classified by the renderer
 between the from color and the to color.
