...
/** @brief A base class for color ramps.
 
 Instances of this class represent color ramps that should be used by a server
 when generating a renderer from either @c AGSUniqueValueDefinition or @c AGSClassBreaksDefinition.
 
 @define{AGSColorRamp.h, ArcGIS}
 @since 10.2.4
 */
