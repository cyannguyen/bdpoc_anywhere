...
/**
 ...
 @param completion The block that will be invoked when the operation completes. The suggestions is an array of @c AGSLocatorSuggestionResult objects.
...
/**
 ...
 @param completion The block that will be invoked when the operation completes. The results is an array of @c AGSLocatorFindResult objects.
 @return A handle to the operation incase you want to cancel it
 @since newAPI
 */
