...
/** Return interpolation string for @c AGSInterpolation.
...
/** Return @c AGSInterpolation from interpolation.
 @param interpolation The interpolation.
 @return @c AGSInterpolation for @p interpolation.
 @since 10.2.4
 @see AGSInterpolation
 */
...
/** Supported no data interpretations.  These are the interpretations of the
 @c AGSImageServiceLayer noData property.
 @since 10.2.4
 */
...
/** Return interpretation string for @c AGSNoDataInterpretation.
...
/** Return @c AGSNoDataInterpretation from interpretation.
 @param interpretation The interpretation.
 @return @c AGSNoDataInterpretation for @p interpretation.
 @since 10.2.4
 @see AGSNoDataInterpretation
 */
...
/** Return time interval units string for @c AGSTimeIntervalUnits.
...
/** Return @c AGSTimeIntervalUnits from @p unit.
 @param unit The time interval units.
 @return @c AGSTimeIntervalUnits for @p unit.
 @since 10.2.4
 @see AGSTimeIntervalUnits
 */
...
/** Return mosaic method string for @c AGSMosaicMethod.
...
/** Return @c AGSMosaicMethod from mosaicMethod.
 @param mosaicMethod The mosaic method.
 @return @c AGSMosaicMethod for @p mosaicMethod.
 @since 10.2.4
 @see AGSMosaicMethod
 */
AGS_EXTERN AGSMosaicMethod AGSMosaicMethodFromString(NSString *mosaicMethod);

/** Return mosaic operation string for @c AGSMosaicOperationType.
...
/** Return @c AGSMosaicOperationType from mosaicOperation.
 @param mosaicOperation The mosaic operation.
 @return @c AGSMosaicOperationType for @p mosaicOperation.
 @since 10.2.4
 @see AGSMosaicOperationType
 */
AGS_EXTERN AGSMosaicOperationType AGSMosaicOperationFromString(NSString *mosaicOperation);

/** Return @c AGSMosaicMethod from mosaicMethodService.
 ...
 @return @c AGSMosaicMethod for @p mosaicMethodService.
 @since 10.2.4
 @see AGSMosaicMethod
 */
AGS_EXTERN AGSMosaicMethod AGSMosaicMethodFromServiceString(NSString *mosaicMethodService);

/** Return mosaic method service string for @c AGSMosaicMethod.
 @param mosaicMethod The mosaic method.
...
/** Return @c AGSMosaicOperationType from mosaicOperationService.
 ...
 @return @c AGSMosaicOperationType for @p mosaicOperationService.
 @since 10.2.4
 @see AGSMosaicOperationType
 */
AGS_EXTERN AGSMosaicOperationType AGSMosaicOperationFromServiceString(NSString *mosaicOperationService);

/** Return mosaic operation service string for @c AGSMosaicOperationType.
 @param mosaicOperation The mosaic operation.
...
/** Return color ramp type string for @c AGSColorRampType.
...
/** Return @c AGSColorRampType from colorRampType.
 @param colorRampType The color ramp type.
 @return @c AGSColorRampType for @p colorRampType.
 @since 10.2.4
 @see AGSColorRampType
 */
...
/** Return color ramp algorithm string for @c AGSColorRampAlgorithm.
...
/** Return @c AGSColorRampAlgorithm from colorRampAlgorithm.
 @param colorRampAlgorithm The color ramp algorithm.
 @return @c AGSColorRampAlgorithm for @p colorRampAlgorithm.
 @since 10.2.4
 @see AGSColorRampAlgorithm
 */
...
/** Return class breaks classification method string for @c AGSColorRampType.
...
/** Return @c AGSClassBreaksDefinitionClassificationMethod from classificationMethod.
 @param classificationMethod The class breaks classification method.
 @return @c AGSClassBreaksDefinitionClassificationMethod for @p classificationMethod.
 @since 10.2.4
 @see AGSClassBreaksDefinitionClassificationMethod
 */
...
/** Return normalization type string for @c AGSClassBreaksDefinitionNormalizationType.
...
/** Return @c AGSClassBreaksDefinitionNormalizationType from normalizationType.
 @param normalizationType The normalization type.
 @return @c AGSClassBreaksDefinitionNormalizationType for @p normalizationType.
 @since 10.2.4
 @see AGSClassBreaksDefinitionNormalizationType
 */
...
/** Return layer source type string for @c AGSLayerSourceType.
...
/** Return @c AGSLayerSourceType from layerSourceType.
 @param layerSourceType The layer source type.
 @return @c AGSLayerSourceType for @p layerSourceType.
 @since 10.2.4
 @see AGSLayerSourceType
 */
