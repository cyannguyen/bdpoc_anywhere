...
ConfigParser.prototype = {
    ...
    setAuthor: function(author) {
        findOrCreate(this.doc, 'author').text = author;
    },
    authorEmail: function() {
        return this.doc.find('author').attrib['email'];
    },
    setAuthorEmail: function(email) {
        findOrCreate(this.doc, 'author').attrib['email'] = email;
    },
    authorHomepage: function() {
        return this.doc.find('author').attrib['href'];
    },
    setAuthorHomepage: function(href) {
        findOrCreate(this.doc, 'author').attrib['href'] = href;
    },
    mainFile: function() {
        var content = this.doc.find('content');
        return content ? content.attrib['src'] : null;
    },
    setMainFile: function(src) {
        findOrCreate(this.doc, 'content').attrib['src'] = src;
    },
