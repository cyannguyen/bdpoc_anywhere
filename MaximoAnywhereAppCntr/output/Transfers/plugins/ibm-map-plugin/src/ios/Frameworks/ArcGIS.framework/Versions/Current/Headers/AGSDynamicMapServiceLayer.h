...
/** A collection of @c AGSDynamicLayerInfo objects for one or more sub-layers of the dynamic ArcGIS Map Service.
 @since 10.2.4
 */
...
/** Returns the sublayer URL for the given @c AGSDynamiclayerInfo.
