...
```
git clone git@github.com:your-username/phonegap-plugin-contentsync.git
```
...
git remote add upstream https://github.com/phonegap/phonegap-plugin-contentsync.git
```
...
The project uses [.jshintrc](http://jshint.com/) to define the JavaScript
