...
/*
This class provides the Browser hook script functionality for before emulate for Browser.

projectDirectory - Path to the project
 */
function BrowserBeforeEmulate(projectDirectory) {
    ...
    function logSilly(message) {
        log.silly(hookConsts.BROWSER_BEFORE_EMULATE, message);
    }
    ...
    function logVerbose(message) {
        log.verbose(hookConsts.BROWSER_BEFORE_EMULATE, message);
    }
    ...
    */
    ...
    ex. cordova emulate --target=Firefox
    ...
    */
    ...
    this.invokeHook = function() {
        logVerbose('Performing before emulate hook.');
        try {
...
BrowserBeforeEmulate.prototype = new Hook();
module.exports = BrowserBeforeEmulate;
