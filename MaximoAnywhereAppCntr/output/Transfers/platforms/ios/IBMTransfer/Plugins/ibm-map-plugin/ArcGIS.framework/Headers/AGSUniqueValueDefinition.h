...
/** @brief This class defines a unique value renderer when requesting a renderer from a dynamic map service's
...
/** Initialize a  @c AGSUniqueValueDefinition with the given array of unique value fields.
...
/** Create a new @c AGSUniqueValueDefinition with the given array of unique value fields.
 @param uniqueValueFields array holding up to three fields used define a unique value for a given feature.
