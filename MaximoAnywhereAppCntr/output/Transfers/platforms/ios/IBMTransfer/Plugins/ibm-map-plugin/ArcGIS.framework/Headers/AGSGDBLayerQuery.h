...
/** @brief Parameters to download a sync-enabled geodatabase
  ...
  In addition to the @c AGSGDBGenerateParameters#layerIDs and @c AGSGDBGenerateParameters#extent parameters, parameters on this class can be used to further define what is included in the sync-enabled geodatabase for each layer or table.
...
/** An attribute query to specify which features should be included.
 ...
 @since 10.2
 @deprecated Deprecated at 10.2.4. Please use @c AGSGDBLayerQuery#whereClause instead.
 */
