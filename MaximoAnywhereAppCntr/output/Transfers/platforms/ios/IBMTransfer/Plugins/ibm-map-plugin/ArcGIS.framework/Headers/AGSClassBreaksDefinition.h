...
/** @brief This class defines a class breaks renderer when requesting a renderer from a dynamic map service's
...
/** Initialize a  @c AGSClassBreaksDefinition with the given classification field, method
...
/** Initialize a @c AGSClassBreaksDefinition object with the given classification field, method,
...
/** Initialize a @c AGSClassBreaksDefinition object with classification by standard deviation
...
/** Initialize a @c AGSClassBreaksDefinition object with the given classification field and method,
...
/** Create a new @c AGSClassBreaksDefinition with the given classification field, method
 and desired number of breaks.
 @param classificationField field used to classify the data.
 @param classificationMethod method used to classify the data.
 @param breakCount number of breaks to be used.
...
/** Create a new @c AGSClassBreaksDefinition object with the given classification field, method,
 desired number of breaks and normalization method.
 @param classificationField field used to classify the data.
 @param classificationMethod method used to classify the data.
 @param breakCount number of breaks to be used.
...
/** Create a new @c AGSClassBreaksDefinition object with classification by standard deviation
 with the given classification field, and standard deviation interval.
 @param classificationField field used to classify the data.
 @param standardDeviationInterval the standard deviation interval.
 @return A new class breaks definition.
...
/** Create a new @c AGSClassBreaksDefinition object with the given classification field and method,
 desired number of breaks and normalizing by a given field.
 @param classificationField field used to classify the data.
 @param classificationMethod method used to classify the data.
 @param breakCount number of breaks to be used.
