...
/** @brief Parameters for a suggest operation on @c AGSLocator
 
 Instances of this class represent parameters for @c AGSLocator#suggestionsWithParameters: operation.
