...
/** @brief This task is used to generate a renderer from a map service’s generateDataClasses REST end-point.
 ...
 where clause are set using the @c AGSGenerateRendererParameters object.
 @since 10.2.4
 */
...
/** Generates the renderer using the supplied @p parameters and @p completionBlock
 ...
 @return the @c NSOperation for the task.
 @since 10.2.4
 */
