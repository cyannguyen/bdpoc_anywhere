...
/** @brief Instances of this class represent drawing information about a sub-layer of a dynamic ArcGIS Map Service.
 
 @define{AGSDrawingInfo.h, ArcGIS}
 @since 10.2.4
*/
...
/** An array of @c AGSLabelClass objects representing the labeling information associated with this sub-layer.
 @since 10.2.4
 */
...
/** Initialize a  @c AGSDrawingInfo with the given renderer and opacity.
...
/** Create a new @c AGSDrawingInfo with the given renderer and opacity.
 @param renderer renderer to be assigned to the layer.
 @param opacity opacity for the layer as a value between 0(fully transparent) and 1(fully opaque).
