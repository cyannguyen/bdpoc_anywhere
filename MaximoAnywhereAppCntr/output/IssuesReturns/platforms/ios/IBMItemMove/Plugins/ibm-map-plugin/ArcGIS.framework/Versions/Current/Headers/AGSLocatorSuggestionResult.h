...
/** @brief Result from a suggest operation on @c AGSLocator
 
 Instances of this class represent individual results returned by @c AGSLocator#suggestionsWithParameters: operation.
