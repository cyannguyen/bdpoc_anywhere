...
// Build: 2023-04-26 15:55:37
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/ActualMaterialListItem", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.ActualMaterialListItem", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            domClass.add(table, 'layout ActualMaterialListItem ');

            var row = table.insertRow(-1);
            row.className  = 'ActualMaterialListItem_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'ActualMaterialListItem_item1_column';
            ...
            var row = table.insertRow(-1);
            row.className  = 'ActualMaterialListItem_row_1';

            var col_item2 = row.insertCell(-1);
            col_item2.className  = 'ActualMaterialListItem_item2_column';
            ...
            col_item3.className  = 'ActualMaterialListItem_item3_column';
            col_item3.colSpan = '2';
