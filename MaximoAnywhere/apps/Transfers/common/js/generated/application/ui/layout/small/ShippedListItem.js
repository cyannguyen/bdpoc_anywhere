...
// Build: 2023-04-26 15:55:40
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/ShippedListItem", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.ShippedListItem", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            row.className  = 'ShippedListItem_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'ShippedListItem_item1_column';
            col_item1.colSpan = '1';
            ...
            col_item2.className  = 'ShippedListItem_item2_column';
            col_item2.colSpan = '2';
            ...
            var row = table.insertRow(-1);
            row.className  = 'ShippedListItem_row_1';

            var col_item3 = row.insertCell(-1);
            col_item3.className  = 'ShippedListItem_item3_column';
            col_item3.colSpan = '1';
            ...
            col_item4.className  = 'ShippedListItem_item4_column';
            col_item4.colSpan = '2';
            ...
            var row = table.insertRow(-1);
            row.className  = 'ShippedListItem_row_2';

            var col_item5 = row.insertCell(-1);
            col_item5.className  = 'ShippedListItem_item5_column';
            col_item5.colSpan = '1';
            col_item5.style['text-align'] = 'left';
            ...
            col_item6.className  = 'ShippedListItem_item6_column';
            col_item6.colSpan = '2';
            col_item6.style['text-align'] = 'left';
            ...
            var row = table.insertRow(-1);
            row.className  = 'ShippedListItem_row_3';

            var col_item7 = row.insertCell(-1);
            col_item7.className  = 'ShippedListItem_item7_column';
            col_item7.colSpan = '1';
            col_item7.style['text-align'] = 'left';
            ...
            col_item8.className  = 'ShippedListItem_item8_column';
            col_item8.colSpan = '2';
            col_item8.style['text-align'] = 'left';
            ...
            var row = table.insertRow(-1);
            row.className  = 'ShippedListItem_row_4';

            var col_item9 = row.insertCell(-1);
            col_item9.className  = 'ShippedListItem_item9_column';
            col_item9.colSpan = '3';
            col_item9.style['text-align'] = 'left';
