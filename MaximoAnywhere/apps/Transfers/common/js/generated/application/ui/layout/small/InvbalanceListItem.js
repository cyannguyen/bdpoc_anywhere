...
// Build: 2023-04-25 12:01:04
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/InvbalanceListItem", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.InvbalanceListItem", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            row.className  = 'InvbalanceListItem_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'InvbalanceListItem_item1_column';
            col_item1.colSpan = '3';
            ...
            col_item2.className  = 'InvbalanceListItem_item2_column';
            col_item2.colSpan = '6';
            ...
            var row = table.insertRow(-1);
            row.className  = 'InvbalanceListItem_row_1';

            var col_item3 = row.insertCell(-1);
            col_item3.className  = 'InvbalanceListItem_item3_column';
            col_item3.colSpan = '3';
            ...
            col_item4.className  = 'InvbalanceListItem_item4_column';
            col_item4.colSpan = '6';
            ...
            var row = table.insertRow(-1);
            row.className  = 'InvbalanceListItem_row_3';

            var col_item7 = row.insertCell(-1);
            col_item7.className  = 'InvbalanceListItem_item7_column';
            col_item7.colSpan = '9';
            ...
            var row = table.insertRow(-1);
            row.className  = 'InvbalanceListItem_row_2';

            var col_item5 = row.insertCell(-1);
            col_item5.className  = 'InvbalanceListItem_item5_column';
            col_item5.colSpan = '5';
            ...
            col_item6.className  = 'InvbalanceListItem_item6_column';
            col_item6.colSpan = '4';
