...
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/CrewLaborList", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.CrewLaborList", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            domClass.add(table, 'layout CrewLaborList ');

            var row = table.insertRow(-1);
            row.className  = 'CrewLaborList_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'CrewLaborList_item1_column';
            col_item1.colSpan = '4';
            ...
            col_item2.className  = 'CrewLaborList_item2_column';
            col_item2.colSpan = '8';
            ...
            var row = table.insertRow(-1);
            row.className  = 'CrewLaborList_row_1';

            var col_item5 = row.insertCell(-1);
            col_item5.className  = 'CrewLaborList_item5_column';
            col_item5.colSpan = '4';
            ...
            col_item4.className  = 'CrewLaborList_item4_column';
            col_item4.colSpan = '6';
            ...
            col_item3.className  = 'CrewLaborList_item3_column';
            col_item3.colSpan = '2';
