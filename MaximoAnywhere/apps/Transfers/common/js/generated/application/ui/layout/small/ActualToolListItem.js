...
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/ActualToolListItem", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.ActualToolListItem", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            domClass.add(table, 'layout ActualToolListItem ');

            var row = table.insertRow(-1);
            row.className  = 'ActualToolListItem_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'ActualToolListItem_item1_column';
            ...
            var row = table.insertRow(-1);
            row.className  = 'ActualToolListItem_row_1';

            var col_item2 = row.insertCell(-1);
            col_item2.className  = 'ActualToolListItem_item2_column';
            ...
            col_item3.className  = 'ActualToolListItem_item3_column';
            col_item3.colSpan = '2';
