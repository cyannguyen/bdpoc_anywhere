...
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/ShipmentLookupListItem", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.ShipmentLookupListItem", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            row.className  = 'ShipmentLookupListItem_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'ShipmentLookupListItem_item1_column';
            col_item1.colSpan = '3';
            ...
            col_item2.className  = 'ShipmentLookupListItem_item2_column';
            col_item2.colSpan = '3';
            ...
            col_item3.className  = 'ShipmentLookupListItem_item3_column';
            col_item3.colSpan = '3';
            ...
            col_item4.className  = 'ShipmentLookupListItem_item4_column';
            col_item4.colSpan = '3';
            ...
            col_item5.className  = 'ShipmentLookupListItem_item5_column';
            col_item5.colSpan = '3';
