...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.InvreserveListItem", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            col_item1.className  = 'InvreserveListItem_item1_column';
            col_item1.colSpan = '1';
            ...
            col_item2.className  = 'InvreserveListItem_item2_column';
            col_item2.colSpan = '2';
            ...
            col_item3.className  = 'InvreserveListItem_item3_column';
            col_item3.colSpan = '1';
            ...
            col_item4.className  = 'InvreserveListItem_item4_column';
            col_item4.colSpan = '2';
            ...
            col_item5.className  = 'InvreserveListItem_item5_column';
            col_item5.colSpan = '1';
            ...
            col_item6.className  = 'InvreserveListItem_item6_column';
            col_item6.colSpan = '2';
            ...
            col_item7.className  = 'InvreserveListItem_item7_column';
            col_item7.colSpan = '3';
            ...
            var row = table.insertRow(-1);
            row.className  = 'InvreserveListItem_row_4';
