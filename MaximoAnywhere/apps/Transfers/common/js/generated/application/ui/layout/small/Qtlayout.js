...
// Build: 2023-04-26 15:55:39
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/Qtlayout", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.Qtlayout", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            domClass.add(table, 'layout Qtlayout ');

            var row = table.insertRow(-1);
            row.className  = 'Qtlayout_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'Qtlayout_item1_column';
            col_item1.colSpan = '6';
            ...
            col_item2.className  = 'Qtlayout_count2_column';
            col_item2.colSpan = '6';
            ...
            var row = table.insertRow(-1);
            row.className  = 'Qtlayout_row_1';

            var col_item3 = row.insertCell(-1);
            col_item3.className  = 'Qtlayout_item3_column';
            col_item3.colSpan = '6';
            ...
            col_item4.className  = 'Qtlayout_count4_column';
            col_item4.colSpan = '6';
            ...
            var row = table.insertRow(-1);
            row.className  = 'Qtlayout_row_2';

            var col_item5 = row.insertCell(-1);
            col_item5.className  = 'Qtlayout_item5_column';
            ...
            var row = table.insertRow(-1);
            row.className  = 'Qtlayout_row_4';

            var col_item6 = row.insertCell(-1);
            col_item6.className  = 'Qtlayout_count6_column';
            col_item6.colSpan = '6';
            ...
            col_button1.className  = 'Qtlayout_item8_column';
