...
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/SplitQtyRotateList", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.SplitQtyRotateList", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            domClass.add(table, 'layout SplitQtyRotateList ');

            var row = table.insertRow(-1);
            row.className  = 'SplitQtyRotateList_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'SplitQtyRotateList_item3_column';
            col_item1.colSpan = '3';
            ...
            col_item2.className  = 'SplitQtyRotateList_button1_column';
            col_item2.colSpan = '6';
            ...
            col_item6.className  = 'SplitQtyRotateList_item5_column';
            col_item6.colSpan = '3';
            col_item6.rowSpan = '2';
            ...
            var row = table.insertRow(-1);
            row.className  = 'SplitQtyRotateList_row_1';

            var col_item3 = row.insertCell(-1);
            col_item3.className  = 'SplitQtyRotateList_item1_column';
            col_item3.colSpan = '3';
            ...
            col_item4.className  = 'SplitQtyRotateList_item2_column';
            col_item4.colSpan = '6';
            ...
            var row = table.insertRow(-1);
            row.className  = 'SplitQtyRotateList_row_2';

            var col_item5 = row.insertCell(-1);
            col_item5.className  = 'SplitQtyRotateList_item4_column';
            ...
            var row = table.insertRow(-1);
            row.className  = 'SplitQtyRotateList_row_3';

            var col_item7 = row.insertCell(-1);
            col_item7.className  = 'SplitQtyRotateList_item7_column';
            col_item7.colSpan = '9';
            ...
            col_button1.className  = 'SplitQtyRotateList_item8_column';
