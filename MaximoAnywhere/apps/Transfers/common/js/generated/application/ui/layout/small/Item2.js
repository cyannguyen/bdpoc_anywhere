...
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/Item2", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.Item2", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            domClass.add(table, 'layout Item2 ');

            var row = table.insertRow(-1);
            row.className  = 'Item2_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'Item2_item1_column';
            col_item1.colSpan = '6';
            ...
            col_item2.className  = 'Item2_item2_column';
            col_item2.colSpan = '6';
