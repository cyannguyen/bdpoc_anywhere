    ...
    return declare(
         ...
         */
        {
            ...
            searchReceivedPurchaseOrders: function (eventContext) {
                ...
                var externalPoLocalResource = CommonHandler._getAdditionalResource(
                    eventContext,
                    "poExternalResource"
                ).getCurrentRecord();
                                            ...
                                            ModelService.filtered(
                                                ...
                                                .then(function (refSet) {
                                                    ...
                                                    eventContext.ui.show(
                                                        "Transfers.POMaterialReceiptsListView"
                                                    );
                                                })
            ...
            searchPurchaseOrders: function (eventContext, purchaseOrderResource) {
                ...
                var formno = poExternalResource.get("formno");
                ...
                var completeStatus = SynonymDomain.resolveToExternal(
                    domaininvusereceipts,
                    "COMPLETE"
                );
                ...
                this._searchPurchaseOrders(eventContext, filter, purchaseOrderResource).then(
                    function (poSet) {
                        //#region Loc-In: Add FormNo field
                        //if(ponum){
                        if (ponum || formno) {
                            ...
                            if (poSet.count() > 0) {
                                ...
                                var totalRecordCount = poSet.count();
                                ...
                                if (poSet.count() >= totalRecordCount) {
                                    var msg =
                                        MessageService.createStaticMessage(
                                            "poReceived"
                                        ).getMessage();
                                ...
                                var msg =
                                    MessageService.createStaticMessage("invalidPO").getMessage();
                                self.ui.showMessage(msg);
                                return;
                            }
                        ...
                        domainpostatus.clearFilterAndSort();
                        var inprgPOStatus = SynonymDomain.resolveToExternal(
                            domainpostatus,
                            "INPRG"
                        );
                        ...
                        if (poSet.count() > 1) {
                            ...
                            domainpostatus.clearFilterAndSort();
                            var currentPOStatus = SynonymDomain.resolveToInternal(
                                domainpostatus,
                                status
                            );
                            ...
                            if (
                                !canReceive ||
                                currentPOStatus == "HOLD" ||
                                currentPOStatus == "REVISE" ||
                                currentPOStatus == "PNDREV"
                            ) {
                            ...
                            ModelService.empty("receiptInput").then(function (receiptInputSet) {
                                poSet.data[0]
                                    .getModelDataSet("poline", true)
                                    .then(function (polineSet) {
                                        var deferreds = [];
                                        var count = 0;
                                        arrayUtil.forEach(polineSet.data, function (poline) {
                                            //skip if linetype of service or material
                                            var polinetype = poline.get("linetype");
                                            var additionalLineType =
                                                CommonHandler._getAdditionalResource(
                                                    eventContext,
                                                    "additionalLineType"
                                                );
                                            ...
                                            var formno = poRec.get("formno");
                                            if (formno) {
                                                filter.push({ formno: formno });
                                                //oslcQueryParameters.push({'sqp:formno':formno})
                                            }
                                            //#endregion Loc-Out: Add FormNo field
                                            var matrectransPromise = ModelService.filtered(
                                                "poListComplexMatrectrans",
                                            ...
                                            matrectransPromise.then(function (matrectransSet) {
                                                ...
                                                if (orderQty) {
                                                    ...
                                                    arrayUtil.forEach(
                                                        ...
                                                        function (matrectrans) {
                                                            if (
                                                                matrectrans.polinenum ==
                                                                poline.polinenum
                                                            ) {
                                                                var inspectionRequired =
                                                                    poline.inspectionrequired;
                                                                var itemnum = poline.itemnum;
                                                                var rotating = poline.rotating;
                                                                var issue = matrectrans.issue;
                                                                var issueType =
                                                                    matrectrans.issuetype;
                                                                var internalIssueType =
                                                    ...
                                                    if (matrectransQuantityDue > 0) {
                                                        ...
                                                        newReceiptInputRecord.set(
                                                            "qtyrequested",
                                                            poline.orderqty /*poline.get('orderqty') - qtySum*/
                                                        );
                                                        newReceiptInputRecord.set(
                                                            "currencyamtrcved",
                                                            poline.receivedtotalcost
                                                        );
            ...
            clearSearchFields: function (eventContext) {
                var poExternalResource = CommonHandler._getAdditionalResource(
                    eventContext,
                    "poExternalResource"
                ).getCurrentRecord();
                poExternalResource.setNullValue("ponum");
            ...
            clearSearchFieldsAndBack: function (eventContext) {
                var handler =
                    eventContext.application["application.handlers.ManagePurchaseOrderHandler"];
            ...
            hideShowPOExtErrorLink: function (eventContext) {
                ...
                self.errorWatch2 = topic.subscribe(
                    PlatformConstants.DATA_REFRESH_TOPIC + "/poComplexMatrectrans",
                    function (fireEvent) {
            ...
            hideShowPOListComplexExtErrorLink: function (eventContext) {
                ...
                self.errorWatch3 = topic.subscribe(
                    PlatformConstants.DATA_REFRESH_TOPIC + "/poListComplexMatrectrans",
                    function (fireEvent) {
                        handler
                            .errorCheckPOListComplexExtReturn(eventContext)
                            .then(function (errorSet) {
                                eventContext.setLabel(
                                    MessageService.createResolvedMessage("errorExists")
                                );
            ...
            filterVendorForLookup: function (eventContext) {
                var additionalvendor = CommonHandler._getAdditionalResource(
                    eventContext,
                    "additionalvendor"
                );
                var filter = [];
            ...
            validateVendor: function (eventContext) {
                ...
                var vendorSet = additionalvendor.find(
                    "company == $1 && orgid == $2",
                    vendor,
                    orgid
                );
            ...
            validatePO: function (eventContext) {
                ...
                var domainporeceipts = CommonHandler._getAdditionalResource(
                    eventContext,
                    "domaininvusereceipts"
                );
                var domainpostatus = CommonHandler._getAdditionalResource(
            ...
            setFieldsReadonly: function (eventContext) {
                ...
                var formno = poExternalResource.getPendingOrOriginalValue("formno");
                if (ponum) {
                    poExternalResource.getRuntimeFieldMetadata("vendor").set("readonly", true);
                    poExternalResource.getRuntimeFieldMetadata("formno").set("readonly", true);
                } else if (vendor) {
                    poExternalResource.getRuntimeFieldMetadata("ponum").set("readonly", true);
                    poExternalResource.getRuntimeFieldMetadata("formno").set("readonly", true);
                } else if (formno) {
                    ...
                    poExternalResource.getRuntimeFieldMetadata("ponum").set("readonly", false);
                    poExternalResource.getRuntimeFieldMetadata("vendor").set("readonly", false);
                    poExternalResource.getRuntimeFieldMetadata("formno").set("readonly", false);
                }
                //#endregion Loc-In: adjust for formno fields
            },
            ...
            clearPOSelection: function (eventContext) {
                var poExtRes = eventContext.application
                    .getResource("poExternalResource")
                    .getCurrentRecord();
                poExtRes.set("ponum", "");
                            ...
                            .then(function () {
                                ...
                                matrectransPromise
                                    .then(function (matrectransSet) {
                                        ...
                                        deferredsArray.push(
                                            self.prepareExternalMatrectransListToReturn(
                                                eventContext,
                                                matrectransSet,
                                                "return"
                                            )
                                        ...
                                        all(deferredsArray).then(function (results) {
                                            ...
                                            arrayUtil.forEach(results, function (resultObject) {
                                                if (resultObject.dataSet.count() > 0) {
                                                    if (resultObject.isRotating) {
                                                        ...
                                                        self.mergeAssettransWithMatrectrans(
                                                            eventContext,
                                            ...
                                            eventContext.application.hideBusy();
                                            eventContext.ui.show(
                                                "Transfers.PurchaseOrderItemsToReturnListView"
                                            );
                                            //});
                                        });
                                    })
                        ...
                        if (hasConnectivity) {
                            ...
                            flushPromise
                                .then(function () {
                                    ...
                                    assettransPromise
                                        .then(function (assettransSet) {
                                            //TODO implement logic return rotating item
                                            Logger.trace(
                                                self._className +
                                                    "assettrans size = " +
                                                    assettransSet.data.length
                                            );
                                            var returnIssueType =
                                            ...
                                            matrectransPromise
                                                .then(function (matrectransSet) {
                                                    ...
                                                    poPromise
                                                        .then(function (poSet) {
                                                            var getPOLineModelPromise =
                                                                poSet.data[0].getModelDataSet(
                                                                    "poline",
                                                                    true
                                                                );
                                                            getPOLineModelPromise
                                                                .then(function (polineSet) {
                                                                    //For each assettrans
                                                                    for (
                                                                        var i = 0;
                                                                        ...
                                                                        var assettransRecord =
                                                                            assettransSet.data[i];

                                                                        //Getting poline resource
                                                                        polineSet.clearFilterAndSort();
                                                                        polineSet.filter(
                                                                            'polinenum == "' +
                                                                                assettransRecord.polinenum +
                                                                                '"'
                                                                        );
                                                                        var polineRecord =
                                                                            polineSet.getRecordAt(
                                                                                0
                                                                            );

                                                                        //Getting matrectrans resource
                                                                        matrectransSet.clearFilterAndSort();
                                                                        matrectransSet.filter(
                                                                            'rotassetnum == "' +
                                                                                assettransRecord.assetnum +
                                                                                '" && ponum == "' +
                                                                                assettransRecord.ponum +
                                                                                '" && positeid == "' +
                                                                                assettransRecord.positeid +
                                                                                '"'
                                                                        );
                                                                        ...
                                                                        if (
                                                                            matrectransSet.count() !=
                                                                            0
                                                                        ) {
                                                                            invalidaAssettransArray.push(
                                                                                assettransRecord.assettransid
                                                                            );
                                                                            Logger.trace(
                                                                                self._className +
                                                                                    "Invalid assettrans due: no matrectrans"
                                                                            );
                                                                            continue;
                                                                        }
                                                                        ...
                                                                        if (
                                                                            ...
                                                                            if (
                                                                                ...
                                                                                Logger.trace(
                                                                                    self._className +
                                                                                        "Invalid assettrans due: assettrans moved"
                                                                                );
                                                                                continue;
                                                                            }

                                                                            if (
                                                                                assettransRecord.itemnum !=
                                                                                polineRecord.itemnum
                                                                            ) {
                                                                                invalidaAssettransArray.push(
                                                                                    assettransRecord.assettransid
                                                                                );
                                                                                Logger.trace(
                                                                                    self._className +
                                                                                        "Invalid assettrans due: different itemnum"
                                                                                );
                                                                                continue;
                                                                            }
                                                                            ...
                                                                            if (
                                                                                ...
                                                                                if (
                                                                                    assettransRecord.location !=
                                                                                    assettransRecord.toloc
                                                                                ) {
                                                                                    invalidaAssettransArray.push(
                                                                                        assettransRecord.assettransid
                                                                                    );
                                                                                    Logger.trace(
                                                                                        self._className +
                                                                                            "Invalid assettrans due: different location"
                                                                                    );
                                                                                    continue;
                                                                                }
														...
														*/
                                                                                ...
                                                                                if (
                                                                                    ...
                                                                                    assettransRecord.binnum !=
                                                                                    assettransRecord.tobin
                                                                                ) {
                                                                                    invalidaAssettransArray.push(
                                                                                        assettransRecord.assettransid
                                                                                    );
                                                                                    Logger.trace(
                                                                                        self._className +
                                                                                            "Invalid assettrans due: different bin destination"
                                                                                    );
                                                                                    continue;
                                                                                }
                                                                                ...
                                                                                if (
                                                                                    ...
                                                                                    if (
                                                                                        assettransRecord.unitcost !=
                                                                                        assettransRecord.invcost
                                                                                    ) {
                                                                                        invalidaAssettransArray.push(
                                                                                            assettransRecord.assettransid
                                                                                        );
                                                                                        Logger.trace(
                                                                                            self._className +
                                                                                                "Invalid assettrans due: different cost"
                                                                                        );
                                                                                        continue;
                                                                                    }
                                                                                }
                                                                    ...
                                                                    arrayUtil.forEach(
                                                                        invalidaAssettransArray,
                                                                        function (id) {
                                                                            assettransSet.filter(
                                                                                'assettransid != "' +
                                                                                    id +
                                                                                    '"'
                                                                            );
                                                                    ...
                                                                    prepareExternalListRotatingItemsToReturnDeferred.resolve(
                                                                        {
                                                                            dataSet: assettransSet,
                                                                            isRotating: true,
                                                                        }
                                                                    );
                                                                })
                                        ...
                                        .otherwise(function (error) {
                                            Logger.trace(
                                                self._className + ": assettrans promise " + error
                                            );
                                        });
                                })
                                .otherwise(function (error) {
                                ...
                                matrectransPromise
                                    .then(function (matrectransSet) {
                                        ...
                                        self.prepareExternalMatrectransListToReturn(
                                            ...
                                            eventContext.application.hideBusy();
                                            eventContext.ui.show(
                                                "Transfers.PurchaseOrderItemsToVoidListView"
                                            );
                                        });
                                    })
                                    .otherwise(function (error) {
             ...
             * @public
             */
            prepareExternalMatrectransListToReturn: function (
                eventContext,
                matrectransSet,
                returnProcess
            ) {
                ...
                var canReceivePreProcessPromise = this.canReceivePreProcess(
                    eventContext,
                    isReturnProcess
                );
                canReceivePreProcessPromise
                    .then(function (response) {
                        ...
                        for (var i = 0; i < matrectransSet.data.length; i++) {
                            ...
                            if (isReturnProcess && isRotatingItem) {
                                ...
                                Logger.trace(
                                    self._className +
                                        "Invalid matrectrans due: return process and rotating item"
                                );
                                continue;
                            }
                            ...
                            if (isVoidProcess) {
                                ...
                                if (matrectransRecord.invoice) {
                                    var invoiceChildrenPromise = matrectransRecord.getModelDataSet(
                                        "invoice",
                                        true
                                    );
                                    deferreds.push(invoiceChildrenPromise);
                                    invoiceChildrenPromise
                                        .then(function (invoiceSet) {
                                            if (
                                                invoiceSet.data.length > 0 &&
                                                invoiceSet.data[0].status.toUpperCase() == "APPR"
                                            ) {
                                                invalidMarectrans.push(
                                                    matrectransRecord.matrectransid
                                                );
                                                Logger.trace(
                                                    self._className +
                                                        "Invalid matrectrans due: invoice approved"
                                                );
                                            }
                                        })
                                        .otherwise(function (error) {
                                ...
                                var isInvoiceMatchRelationEmptyPromise =
                                    self.isInvoiceMatchRelationEmpty(
                                        eventContext,
                                        matrectransRecord
                                    );
                                deferreds.push(isInvoiceMatchRelationEmptyPromise);
                                isInvoiceMatchRelationEmptyPromise
                                    .then(function (response) {
                                        if (!response.isEmpty) {
                                            invalidMarectrans.push(response.object.matrectransid);
                                            Logger.trace(
                                                self._className +
                                                    "Invalid matrectrans due: invoice match relation is empty"
                                            );
                                        }
                                    })
                                    .otherwise(function (error) {
                                ...
                                var isReturnExternalReceiptsRelationEmptyPromise =
                                    self.isReturnExternalReceiptsRelationEmpty(
                                        eventContext,
                                        matrectransRecord
                                    );
                                deferreds.push(isReturnExternalReceiptsRelationEmptyPromise);
                                isReturnExternalReceiptsRelationEmptyPromise
                                    .then(function (response) {
                                        if (!response.isEmpty) {
                                            invalidMarectrans.push(response.object.matrectransid);
                                            Logger.trace(
                                                self._className +
                                                    "Invalid matrectrans due: return receipt relation is empty"
                                            );
                                        }
                                    })
                                    .otherwise(function (error) {
                                ...
                                if (
                                    ...
                                    invalidMarectrans.push(matrectransRecord.matrectransid);
                                    Logger.trace(
                                        self._className + "Invalid matrectrans due: receipt status"
                                    );
                                    continue;
                                }
                            }
                            ...
                            var getQuantityToReturnPromise = self.getQuantityToReturn(
                                eventContext,
                                matrectransRecord,
                                isVoidProcess
                            );
                            deferreds.push(getQuantityToReturnPromise);
                            getQuantityToReturnPromise
                                .then(function (response) {
                                    if (response.object.qtyToBeReturned == 0) {
                                        invalidMarectrans.push(response.object.matrectransid);
                                        Logger.trace(
                                            self._className +
                                                "Invalid matrectrans due: no quantity to return"
                                        );
                                    }

                                    Logger.trace(
                                        self._className + "quantity response is : " + response.qty
                                    );
                                })
                                .otherwise(function (error) {
                                    Logger.trace(self._className + ": " + error);
                ...
                poPromise.then(function (poSet) {
                    ...
                    getPOLineModelPromise.then(function (polineSet) {
                        ...
                        for (var i = 0; i < size; i++) {
                            ...
                            if (
                                matrectransToVoid.lifofiforeturnqty &&
                                matrectransToVoid.qtyToBeReturned > lifofiforeturnqty
                            ) {
                                Logger.error(
                                    "Returning item " +
                                        matrectransToVoid.itemnum +
                                        " more than receipt quantity."
                                );
                                var msg = MessageService.createResolvedMessage(
                                    "returnMoreThanReceipt",
                                    [matrectransToVoid.itemnum]
                                );
                                self.ui.showMessage(msg);
                                return;
                            ...
                            self.prepareReturnExternalReceipt(
                                eventContext,
                                newReceipt,
                                matrectransToVoid,
                                "void",
            ...
            getQuantityToReturn: function (eventContext, matRecParent, isVoidProcess) {
                ...
                var costTypeSet = CommonHandler._getAdditionalResource(
                    eventContext,
                    "domaincosttype"
                );
                var filter = [];
                ...
                filter.push({
                    issuetype: SynonymDomain.resolveToDefaultExternal(issueTypeSet, "TRANSFER"),
                });
                oslcQueryParameters = {};
                ...
                matrectransChildrenPromise
                    .then(function (matrecChildrenSet) {
                        ...
                        var getInventoryPromise = self.getInventoryFromMatrectrans(
                            matrectransRef,
                            matRecParent
                        );
                        getInventoryPromise
                            .then(function (result) {
                                ...
                                if (
                                    ...
                                    invObject
                                        .getModelDataSet("invlifofifocost", true)
                                        .then(function (invlifofifocostSet) {
                                            arrayUtil.forEach(
                                                invlifofifocostSet.data,
                                                function (invlifofifoRecord) {
                                                    if (
                                                        receiptId ==
                                                            invlifofifoRecord.refobjectid &&
                                                        invlifofifoRecord.refobject.toUpperCase() ==
                                                            "MATRECTRANS"
                                                    ) {
                                                        lifoFifoReturnQty =
                                                            lifoFifoReturnQty +
                                                            invlifofifoRecord.quantity;
                                                    }
                                                }
                                            );
                                    ...
                                    self.calcQuantityToReturn(
                                        ...
                                        .then(function (response) {
                                            ...
                                            matrectransInnerObject.qtyToBeReturned =
                                                qtyToBeReturned;
            ...
            calcQuantityToReturn: function (eventContext, matRecParent, isVoidProcess) {
                ...
                matrectransChildrenPromise
                    .then(function (matrecChildrenSet) {
                        var returnExtIssuetype = SynonymDomain.resolveToDefaultExternal(
                            issueTypeSet,
                            "RETURN"
                        );
                        var voidreceiptExtIssuetype = SynonymDomain.resolveToDefaultExternal(
                            issueTypeSet,
                            "VOIDRECEIPT"
                        );
            ...
            getInventoryFromMatrectrans: function (eventContext, matrectrans, matRecParent) {
                ...
                var inventoryChildrenPromise = ModelService.filtered(
                    "inventory",
                    PlatformConstants.SEARCH_RESULT_QUERYBASE,
                    filter,
                    1000,
                ...
                inventoryChildrenPromise
                    .then(function (invChildrenSet) {
                        ...
                        deferred.resolve({
                            invObject: returnObject,
                            matrecObj: matrectrans,
                            matrecParent: matRecParent,
                        });
                    })
                    .otherwise(function (error) {
                        Logger.trace(self._className + ": " + error);
            ...
            isReturnExternalReceiptsRelationEmpty: function (eventContext, matRecParent) {
                ...
                filter.push({ receiptref: matRecParent.matrectransid.toString() });
                filter.push({
                    issuetype: SynonymDomain.resolveToDefaultExternal(issueTypeSet, "RETURN"),
                });
                oslcQueryParameters = {};
            ...
            canReceivePreProcess: function (eventContext, isReturnProcess) {
                ...
                var pndrevPOStatus = SynonymDomain.resolveToDefaultExternal(
                    domainpostatus,
                    "PNDREV"
                );
                var holdPOStatus = SynonymDomain.resolveToDefaultExternal(domainpostatus, "HOLD");
                var revisePOStatus = SynonymDomain.resolveToDefaultExternal(
                    domainpostatus,
                    "REVISE"
                );
                ...
                poPromise.then(function (poSet) {
                    ...
                    if (!mainPOStatus == apprPOStatus || !mainPOStatus == inprgPOStatus) {
                        ...
                        if (poSet.count() > 1) {
                            ...
                            if (
                                !innerPO.status == apprPOStatus ||
                                !innerPO.status == inprgPOStatus
                            ) {
                                canReceive = false;
                            }
                        }
                    ...
                    if (
                        mainPOStatus == holdPOStatus ||
                        mainPOStatus == revisePOStatus ||
                        mainPOStatus == pndrevPOStatus
                    ) {
                        canReceive = false;
                    }
		 ...
		 */
             ...
             * @public
             */
            prepareReturnExternalReceipt: function (
                eventContext,
                /*ModelData*/ newReceipt,
                /*ModelData*/ matrectransRef,
                /*string*/ process,
                /*ModelData*/ poLine
            ) {
                var domainIssueTypeSet = CommonHandler._getAdditionalResource(
                    eventContext,
                    "domainissuetype"
                );
                var receiptStatusSet = CommonHandler._getAdditionalResource(
                ...
                if (process.toLowerCase() == "void") {
                    newReceipt.set(
                        "issuetype",
                        SynonymDomain.resolveToDefaultExternal(domainIssueTypeSet, "VOIDRECEIPT")
                    );
                    newReceipt.set("actualdate", matrectransRef.actualdate);
                } else {
                    newReceipt.set(
                        "issuetype",
                        SynonymDomain.resolveToDefaultExternal(domainIssueTypeSet, "RETURN")
                    );
                }
                ...
                if (matrectransSet.count() > 0) {
                    ...
                    currentRecord
                        ...
                        .then(function (rotAssetSet) {
                            ...
                            eventContext.application.showBusy();
                            ModelService.save(saveresource)
                                .then(function () {
                                    eventContext.ui.show("Transfers.TransactionSubmitDialog");
                                })
                                .otherwise(function (err) {
            ...
            resolveConfirmationMessage: function (eventContext) {
                ...
                var messagesMap = [
                    "receiptRequestSucess",
                    "voidRequestSucess",
                    "returnRequestSucess",
                    "inspectionRequestSucess",
                    "rotatingitemRequestSucess",
                ];
            ...
            convertAssettransToReceipt: function (eventContext, assettransSet, receiptInputSet) {
                ...
                var returnIssueType = SynonymDomain.resolveToDefaultExternal(
                    issueTypeSet,
                    "RETURN"
                );
                ...
                arrayUtil.forEach(assettransSet.data, function (assettransRecord) {
                    ...
                    newReceiptInputRecord.set(
                        ...
                        assettransRecord.receiptquantity
                    );
            ...
            mergeAssettransWithMatrectrans: function (eventContext, assettransSet, matrectransSet) {
                ...
                arrayUtil.forEach(assettransSet.data, function (assettransRecord) {
                    ...
                    if (assettransRecord.assetnum == null) {
                        newReceiptInputRecord.set(
                            "qtyToBeReturned",
                            newReceiptInputRecord.receiptquantity
                        );
                        newReceiptInputRecord.set(
                            "receiptquantity",
                            assettransRecord.receiptquantity
                    ...
                    newReceiptInputRecord.set(
                        "matrectransid",
                        parseInt(assettransRecord.matrectransid)
                    );
            ...
            convertMatrectransToReceipt: function (matrectransSet, receiptInputSet) {
                arrayUtil.forEach(matrectransSet.data, function (matrectransRecord) {
                    ...
                    newReceiptInputRecord.set(
                        "quantityAvailableToReturn",
                        matrectransRecord.receiptquantity
                    );
                    ...
                    newReceiptInputRecord.set(
                        "currencylinecost",
                        matrectransRecord.currencylinecost
                    );
            ...
            setEditable: function (eventContext) {
                var rotating = eventContext.getCurrentRecord().get("rotassetnum");
                var receiptInputRecord = CommonHandler._getAdditionalResource(
                    eventContext,
                    "receiptInput"
                ).getCurrentRecord();
                var quantityAvailableToReturn = receiptInputRecord.getRuntimeFieldMetadata(
                    "quantityAvailableToReturn"
                );
            ...
            //#region Loc-In: Customize methods
            ...
            transitionToAttachment: function (eventContext) {
                eventContext.application.showBusy();
