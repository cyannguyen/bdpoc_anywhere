...
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/InvbalanceLookup", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.InvbalanceLookup", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            domClass.add(table, 'layout InvbalanceLookup ');

            var row = table.insertRow(-1);
            row.className  = 'InvbalanceLookup_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'InvbalanceLookup_item1_column';
            col_item1.colSpan = '2';
            ...
            col_item2.className  = 'InvbalanceLookup_item2_column';
            col_item2.colSpan = '4';
            ...
            col_item3.className  = 'InvbalanceLookup_item3_column';
            col_item3.colSpan = '3';
            ...
            col_item4.className  = 'InvbalanceLookup_item4_column';
            col_item4.colSpan = '3';
