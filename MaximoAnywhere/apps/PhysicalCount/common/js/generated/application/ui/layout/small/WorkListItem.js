...
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/WorkListItem", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.WorkListItem", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            domClass.add(table, 'layout WorkListItem ');

            var row = table.insertRow(-1);
            row.className  = 'WorkListItem_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'WorkListItem_item1_column';
            col_item1.colSpan = '2';
            ...
            var col_item2_offset = row.insertCell(-1);
            col_item2_offset.colSpan = '1';
            col_item2_offset.className  = 'WorkListItem_item2_column';
            var col_item2 = row.insertCell(-1);
            col_item2.className  = 'WorkListItem_item2_column';
            col_item2.colSpan = '7';
            ...
            col_button1.className  = 'WorkListItem_button1_column';
            ...
            var row = table.insertRow(-1);
            row.className  = 'WorkListItem_row_1';

            var col_item3 = row.insertCell(-1);
            col_item3.className  = 'WorkListItem_item3_column';
            ...
            var row = table.insertRow(-1);
            row.className  = 'WorkListItem_row_2';

            var col_item5 = row.insertCell(-1);
            col_item5.className  = 'WorkListItem_item5_column';
            col_item5.colSpan = '2';
            ...
            col_item6.className  = 'WorkListItem_item6_column';
            col_item6.colSpan = '5';
            ...
            col_item4.className  = 'WorkListItem_item4_column';
            col_item4.colSpan = '2';
