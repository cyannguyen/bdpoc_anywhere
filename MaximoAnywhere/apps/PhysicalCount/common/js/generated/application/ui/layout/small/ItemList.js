...
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/ItemList", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.ItemList", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            row.className  = 'ItemList_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'ItemList_item1_column';
            col_item1.colSpan = '5';
            ...
            col_item2.className  = 'ItemList_item2_column';
            col_item2.colSpan = '7';
            ...
            var row = table.insertRow(-1);
            row.className  = 'ItemList_row_1';

            var col_item3 = row.insertCell(-1);
            col_item3.className  = 'ItemList_item3_column';
            col_item3.colSpan = '5';
            ...
            col_item4.className  = 'ItemList_item4_column';
            col_item4.colSpan = '7';
            ...
            var row = table.insertRow(-1);
            row.className  = 'ItemList_row_2';

            var col_item5 = row.insertCell(-1);
            col_item5.className  = 'ItemList_item5_column';
            col_item5.colSpan = '5';
            ...
            col_item6.className  = 'ItemList_item6_column';
            col_item6.colSpan = '7';
            ...
            var row = table.insertRow(-1);
            row.className  = 'ItemList_row_3';

            var col_item7 = row.insertCell(-1);
            col_item7.className  = 'ItemList_item7_column';
            col_item7.colSpan = '5';
            ...
            col_item8.className  = 'ItemList_item8_column';
            col_item8.colSpan = '7';
