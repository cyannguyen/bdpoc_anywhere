...
function (thisModule, lang, Logger) {
	...
	var classBody = {
			...
			logError: function(logMessage, error, clazz){
				if(Logger.level >= 2){
					...
					this.error(logMessage + " Error: " + errorStr, null, clazz);
				}
			},
			...
			log : function(string, level, params, clazz) {
				...
				Logger.log(string, level, params, clazz);
			},
