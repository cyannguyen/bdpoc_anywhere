...
function(){
	...
	var result = {
		...
		WORKLIST_DATA_RECEIVED: 'WORKLIST_DATA_RECEIVED',
		BMX_LENGTH: 10,
		BMX_PADDING: 3,
		CLEANUP: true,
		...
		PLUSS_MEASURES_ENABLED: 'pluss.si.map.esri.measureEnabled',
		PLUSS_MEASURE_LENGTH_UNIT: 'pluss.si.map.esri.measureLengthUnit',
		PLUSS_MEASURE_AREA_UNIT: 'pluss.si.map.esri.measureAreaUnit',
		USE_MF_PROXY: 'si.map.esri.useMobileFirstProxy',
		OFFLINE_PAGE_SIZE: 'si.map.offline.pageSize',
		OFFLINE_BYTES_LIMIT: 'si.map.offline.bytesLimitDownload',
		OFFLINE_QUERY_FEATURES_DELAY: 'si.map.offline.queryFeaturesDelay',
		OFFLINE_FEATURES_LIMIT: 'si.map.offline.featuresLimit',
		BAN_PUSH_NOTIFICATION: 'banPushNotification',
		ALLOW_PUSH_NOTIFICATION: 'allowPushNotification',
		SYSTEM_ERROR_LAST_RECEIVED: 'timeSystemErrorReceived'
