...
/**@memberOf platform.codeScanner.nativeBridge.NativeBridgeHelper */
		request: function(/*JSONArray*/ parameters, /*Deferred*/ deferred) {
			...
			PermissionsPlugin.checkAndGrantPermissions(PermissionsPlugin.CAMERA, [PermissionsPlugin.WRITE_EXTERNAL_STORAGE, PermissionsPlugin.READ_EXTERNAL_STORAGE, PermissionsPlugin.CAMERA], this, 
