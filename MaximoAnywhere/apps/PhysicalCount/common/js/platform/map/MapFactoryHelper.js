...
function(declare, lang, Deferred, MapFactory, AbstractMap, MapProperties, Logger) {
		...
		_parseProvider: function(/*String*/ providerUrl, /*JSONObject*/ specificParameters) {
			...
			if(provider) {
				switch(provider.toLowerCase()) {
					case "osm": case "bing": case "google": case MapProperties.ANYWHERE_PROVIDER_MAPMANAGER:
						mapType = "platform.map.OpenLayersMap";
						break;
