...
define({
   root: {
    ...
    // h
    handleTimeOut : 'Request timed out for {0}. Make sure the host address is available to the app (especially relevant for Android and iPhone apps).',
    // i
