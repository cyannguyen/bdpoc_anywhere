...
define("application/handlers/IssuesAvailableItemsHandler", [
    ...
    return declare([ApplicationHandlerBase, AsyncAwareMixin], {
        ...
        completeAvailableItems: function (eventContext) {
            ...
            var issueAdditionalUsage = eventContext.application
            ...
            console.log("Check ", formNumber);
            console.log("Check 2", description);
            console.log("Check 3", createDate);
            console.log("Check 4", actualDate);
            console.log("Check 5", fromlot);
            console.log("Check 6", wnum, location, glaccount);
            ...
            if (additionalItemData.issueQty && additionalItemData.issueQty > 0) {
                ...
                self.ui.showMessage(
                    MessageService.createResolvedMessage("materialQuantityPositive")
                );
                eventContext.application.hideBusy();
            }
        },
        ...
        transitsBackToIssueAdditionalSearchView: function (eventContext) {
            ...
            var handler =
                eventContext.application["application.handlers.IssuesAvailableItemsHandler"];
        ...
        filterDataSetFromLotCurbal: function (eventContext) {
            ...
            record.setNullValue("binnum");
        },

        updateFromLotCurbal: function (eventContext) {
            ...
            formnumberPromise.then(function (data) {
                if (data.length > 0) {
                    data.resourceID = "additionalInvbalance";
        ...
        clearFromBinLotSelection: function (eventContext) {
            ...
            var issueAdditionalItems = eventContext.application
                .getResource("issueAdditionalItems")
                .getCurrentRecord();
        ...
        handleLocationDataChanged: function (eventContext) {
            ...
            ModelService.filtered(
                "additionallocations",
                null,
                [{ location: location, siteid: siteid }],
                null,
                false,
                true
            )
                .then(function (locationSet) {
