...
define("application/handlers/ReturnIssuedItemsHandler", [
    ...
    return declare([ApplicationHandlerBase, AsyncAwareMixin], {
        ...
        // filterFormnummberLookup: function(eventContext) {
        ...
        completeReturn: function (eventContext) {
            ...
            var issueReturnHeader = eventContext.application
                .getResource("issueReturnHeader")
                .getCurrentRecord();
        ...
        clearReturnHeader: function (eventContext) {
            var returnHeaderRecord = eventContext.application
                .getResource("issueReturnHeader")
                .getCurrentRecord();
