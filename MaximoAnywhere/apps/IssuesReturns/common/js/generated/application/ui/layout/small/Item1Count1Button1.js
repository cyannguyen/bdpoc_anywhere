...
// Build: 2023-04-17 13:32:29
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/Item1Count1Button1", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.Item1Count1Button1", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            domClass.add(table, 'layout Item1Count1Button1 ');

            var colgroup = domConstruct.create('colgroup');
            table.appendChild(colgroup);

            var col = domConstruct.create('col');
            domClass.add(col, 'colWidth');
            colgroup.appendChild(col);
            
            var row = table.insertRow(-1);
            row.className  = 'Item1Count1Button1_row_0';

            var col_count1 = row.insertCell(-1);
            col_count1.className  = 'Item1Count1Button1_count1_column';
            col_count1.colSpan = '1';
            ...
            col_item1.className  = 'Item1Count1Button1_item1_column';
            col_item1.colSpan = '6';
            ...
            col_button1.className  = 'Item1Count1Button1_button1_column';
