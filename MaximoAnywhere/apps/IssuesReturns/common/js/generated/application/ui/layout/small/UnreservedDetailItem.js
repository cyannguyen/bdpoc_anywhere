...
// Build: 2023-04-17 13:32:34
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/UnreservedDetailItem", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.UnreservedDetailItem", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            row.className  = 'UnreservedDetailItem_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'UnreservedDetailItem_item1_column';
            col_item1.colSpan = '1';
            ...
            col_item2.className  = 'UnreservedDetailItem_item2_column';
            col_item2.colSpan = '1';
            ...
            var row = table.insertRow(-1);
            row.className  = 'UnreservedDetailItem_row_1';

            var col_item3 = row.insertCell(-1);
            col_item3.className  = 'UnreservedDetailItem_item3_column';
            col_item3.colSpan = '1';
            ...
            col_item4.className  = 'UnreservedDetailItem_item4_column';
            col_item4.colSpan = '1';
            ...
            var row = table.insertRow(-1);
            row.className  = 'UnreservedDetailItem_row_2';

            var col_item5 = row.insertCell(-1);
            col_item5.className  = 'UnreservedDetailItem_item5_column';
            col_item5.colSpan = '1';
            ...
            col_item6.className  = 'UnreservedDetailItem_item6_column';
            col_item6.colSpan = '1';
            ...
            var row = table.insertRow(-1);
            row.className  = 'UnreservedDetailItem_row_3';

            var col_item7 = row.insertCell(-1);
            col_item7.className  = 'UnreservedDetailItem_item7_column';
            col_item7.colSpan = '2';
