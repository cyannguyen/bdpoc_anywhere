...
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/CrewToolList", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.CrewToolList", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            domClass.add(table, 'layout CrewToolList ');

            var row = table.insertRow(-1);
            row.className  = 'CrewToolList_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'CrewToolList_item1_column';
            ...
            var row = table.insertRow(-1);
            row.className  = 'CrewToolList_row_1';

            var col_item2 = row.insertCell(-1);
            col_item2.className  = 'CrewToolList_item2_column';
            ...
            col_item3.className  = 'CrewToolList_item3_column';
            col_item3.colSpan = '2';
