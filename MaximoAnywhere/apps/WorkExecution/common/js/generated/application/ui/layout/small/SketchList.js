...
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/SketchList", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.SketchList", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            domClass.add(table, 'layout SketchList ');

            var row = table.insertRow(-1);
            row.className  = 'SketchList_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'SketchList_item1_column';
            col_item1.colSpan = '7';
            ...
            col_item2.className  = 'SketchList_item2_column';
            col_item2.colSpan = '1';
