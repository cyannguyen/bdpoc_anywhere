...
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/CalibrationItem3", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.CalibrationItem3", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            row.className  = 'CalibrationItem3_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'CalibrationItem3_item1_column';
            col_item1.colSpan = '4';
            ...
            col_item2.className  = 'CalibrationItem3_item2_column';
            col_item2.colSpan = '2';
            ...
            col_item3.className  = 'CalibrationItem3_item3_column';
            col_item3.colSpan = '6';
