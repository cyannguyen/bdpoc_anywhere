...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.PlannedToolListItem", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            domClass.add(table, 'layout PlannedToolListItem ');

            var row = table.insertRow(-1);
            row.className  = 'PlannedToolListItem_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'PlannedToolListItem_item1_column';
            ...
            var row = table.insertRow(-1);
            row.className  = 'PlannedToolListItem_row_1';

            var col_item2 = row.insertCell(-1);
            col_item2.className  = 'PlannedToolListItem_item2_column';
            ...
            col_item3.className  = 'PlannedToolListItem_item3_column';
            col_item3.colSpan = '2';
