...
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/KeyValueFormLayout", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.KeyValueFormLayout", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            domClass.add(table, 'layout KeyValueFormlayout ');

            var row = table.insertRow(-1);
            row.className  = 'KeyValueFormLayout_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'KeyValueFormLayout_item1_column';
            col_item1.colSpan = '4';
            ...
            col_item2.className  = 'KeyValueFormLayout_item2_column';
            col_item2.colSpan = '6';
            ...
            col_item3.className  = 'KeyValueFormLayout_item3_column';
            col_item3.colSpan = '2';
