...
// Build: 2023-04-03 16:48:48
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/MeterList", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.MeterList", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            domClass.add(table, 'layout MeterList ');

            var row = table.insertRow(-1);
            row.className  = 'MeterList_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'MeterList_item1_column';
            col_item1.colSpan = '3';
            ...
            col_item2.className  = 'MeterList_item2_column';
            col_item2.colSpan = '5';
            ...
            col_item3.className  = 'MeterList_item3_column';
            col_item3.colSpan = '3';
            ...
            col_button1.className  = 'MeterList_button1_column';
            ...
            var row = table.insertRow(-1);
            row.className  = 'MeterList_row_1';

            var col_item4 = row.insertCell(-1);
            col_item4.className  = 'MeterList_item4_column';
            col_item4.colSpan = '3';
            ...
            col_item5.className  = 'MeterList_item5_column';
            col_item5.colSpan = '5';
            ...
            col_item6.className  = 'MeterList_item6_column';
            col_item6.colSpan = '3';
