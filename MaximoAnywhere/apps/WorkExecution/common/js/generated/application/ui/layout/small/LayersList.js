...
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/LayersList", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.LayersList", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            domClass.add(table, 'layout LayersList ');

            var row = table.insertRow(-1);
            row.className  = 'LayersList_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'LayersList_item1_column';
            col_item1.colSpan = '7';
            ...
            col_item2.className  = 'LayersList_item2_column';
            col_item2.colSpan = '1';
            ...
            var row = table.insertRow(-1);
            row.className  = 'LayersList_row_1';

            var col_item4 = row.insertCell(-1);
            col_item4.className  = 'LayersList_item4_column';
            col_item4.colSpan = '1';
            ...
            var row = table.insertRow(-1);
            row.className  = 'LayersList_row_2';

            var col_item5 = row.insertCell(-1);
            col_item5.className  = 'LayersList_item5_column';
            col_item5.colSpan = '8';
