...
//----------------------------------------------------------------//
define(   "generated/application/ui/layout/small/IdentifyFeaturesList", 
      [
         "dojo/_base/declare", 
...
function(declare, _LayoutWidgetBase, array, domConstruct, domClass) {
      return declare("generated.application.ui.layout.small.IdentifyFeaturesList", _LayoutWidgetBase, {
         ...
         buildRendering : function() {
            ...
            row.className  = 'IdentifyFeaturesList_row_0';

            var col_item1 = row.insertCell(-1);
            col_item1.className  = 'IdentifyFeaturesList_item1_column_layernamelabel';
            col_item1.colSpan = '6';
            ...
            var row = table.insertRow(-1);
            row.className  = 'IdentifyFeaturesList_row_1';

            var col_item2 = row.insertCell(-1);
            col_item2.className  = 'IdentifyFeaturesList_item2_column_featureFieldName';
            col_item2.colSpan = '6';
            ...
            col_item3.className  = 'IdentifyFeaturesList_item3_column_featureFieldValue';
            col_item3.colSpan = '6';
